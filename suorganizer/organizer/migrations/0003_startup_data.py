...
startup information, instead of starting with an empty database.
"""
...
STARTUPS = [
    {
        "name": "Ranajay On The Road",
        "slug": "ranajay-on-the-road",
        "contact": "ranajay@outlook.com",
        "description":
            "The travel and adventures of Ranajay Das,"
            "as he travels the world in search of his true self.",
        "founded_date": date(2019, 1, 1),
        "tags": ["self-improvement"],
        "website": "http://ranajayontheroad.com/",
    },
    {
        "name": "Arachnobots",
        "slug": "arachnobots",
